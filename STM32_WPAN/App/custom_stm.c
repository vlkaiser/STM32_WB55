...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomLed_SvcHdle;                    /**< LED_SVC handle */
...
/* Private variables ---------------------------------------------------------*/
static const uint8_t SizeMycharwrite=1;
static const uint8_t SizeMycharnotify=1;
/**
 ...
 */
#define COPY_LED_SVC_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x00,0xcc,0x7a,0x48,0x2a,0x98,0x4a,0x7f,0x2e,0xd5,0xb3,0xe5,0x8f)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   * service_max_attribute_record = 1 for LED_SVC +
   *                                2 for myCharWrite +
   *                                2 for myCharNotify +
